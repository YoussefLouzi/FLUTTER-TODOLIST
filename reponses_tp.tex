...
\begin{titlepage}
    ...
    \begin{tabular}{ll}
        ...
        \textbf{Module :} & Développement Mobile
    \end{tabular}
...
\subsection*{11. À quoi sert la flèche =>}
C'est une syntaxe courte pour les fonctions simples. Au lieu d'écrire \{return ...\}, j'écris juste => ... C'est plus compact.

\subsection*{12. Code sans =>}
\begin{verbatim}
